class Data::CitiesController < Data::ApplicationController

  def index
    @cities = Data::City.active._where(params[:where])._order(params[:order]).paginate(:page => params[:page], :per_page => params[:per_page])
