class Admin::Shop::CountriesController < Admin::Shop::ApplicationController

  def index
    @countries = Data::Country.active._where(params[:where])._order(params[:order]).page(params[:page]).per(params[:per_page])
